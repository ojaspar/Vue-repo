<template>
    <b-modal :id="id" :no-close-on-backdrop="closeBackdropOnModal" class="add-entity-modal" @hide="handleHideModal">
        <template v-slot:modal-header="{ cancel }">
            <div class="add-entity-modal__header">
                <h1 class="add-entity-modal__header-text">New Bank</h1>
...
@Component
export default class AddBankModal extends Mixins(UtilityMixins, CurrencyMixin, ValidationMixin) {
    ...
    get modalTitle(): string {
        return (this.isEditing ? 'Edit' : 'Add') + ' Existing Bank Account';
    }
