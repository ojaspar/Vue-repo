<template>
    <b-modal :id="id" :no-close-on-backdrop="closeBackdropOnModal" class="add-entity-modal" @hide="hideDebtorModal">
        <template v-slot:modal-header="{ cancel }">
            <div class="add-entity-modal__header">
                <h1 class="add-entity-modal__header-text">Add Existing Debtor</h1>
        ...
        <div class="setup__modal-buttons-container">
            <BaseButton
                ...
                v-if="isEditing"
                @button-clicked="handleDeletionOfDebtor(indexOfDebtorObjectToBeEdited)"
            />
            <BasePrimaryButton
                buttonText="Save"
                className="setup__save-button"
                @button-clicked="handleAdditionOfDebtor"
...
@Component
export default class AddDebtorModal extends Mixins(UtilityMixins, CurrencyMixin, ValidationMixin) {
