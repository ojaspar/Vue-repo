<template>
    <b-container fluid class="p-0">
        <div :class="[!userIsOnMobile ? 'edit-product__tablet-shadow' : '', 'edit-product']">
            <div class="edit-product__tablet-plus-navigation-header-container">
                <TabletPlusNavigationHeader
                    :activeComponentIndex="activeComponentIndex"
                    pageTitle="Edit Product"
                    className="edit-product__tablet-plus-navigation-header"
                />
            </div>
            <SaleItemSummaryCard :canEdit="true" />
            <b-row>
                <b-col>
            ...
            <b-row>
                <b-col>
                    <BaseInputFieldWithBorderAndFloatingLabel
                        floatingLabelText="Price before VAT"
                        className="edit-product__text-input-field"
                        :value="0"
                    />
                </b-col>
            ...
            <BaseCheckboxWithBorderAndFloatingLabel
                ...
                labelClass="edit-product__checkbox-label"
                :value="12"
            />
            ...
            <div class="edit-product__instant-supply-section" v-if="!instantSupply && !isEstimate">
                <b-row>
                    <b-col>
                        <BaseInputFieldWithBorderAndFloatingLabel
                            floatingLabelText="Quantity Supplied"
                            className="edit-product__text-input-field"
                            inputContainerClass="edit-product__quantity-supplied-field-container"
            ...
            <BaseTextAreaWithBorderAndFloatingLabel
                ...
                className="edit-product__notes-text-area-field"
                v-model="form.notes"
            />

            <BaseButton
                buttonText="Update"
                className="edit-product__update-product-button"
...
export default class EditProduct extends Mixins(
    UtilityMixins,
    CurrencyMixins,
    SalesServiceMixin,
    ...
    //     @Prop({ default: false }) readonly isCustomerCompulsory!: boolean;
    ...
    //             const vatObject = this.vatOptions.find((vatType: VatOption) => vatType.saleProductVatKey === this.itemToBeEdited.vatTypeKey);
    ...
    //         this.$emit('edit-product-to-summary', selectedProductForSale);
    //         this.$emit('edit-product-to-cart', {
    //             ...this.form,
    //             quantity: Number(this.form.quantity),
    //             quantitySupplied: Number(this.form.quantitySupplied),
    //         });
...
<style lang="scss">
@import 'src/styles/pages/sales/edit-product.scss';
</style>
